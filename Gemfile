...
gem 'plan_executor', :git => 'https://github.com/CarthageKing/plan_executor.git', :branch => 'ck_r4'
...
gem 'synthea', :git => 'https://github.com/CarthageKing/synthea.git', :branch => 'ruby'
